...
/**
 * Generator class for Ecore members ({@link EOperation}s and
...
public class EMemberGenerator {
	 ...
	 */
	public EMemberGenerator(EDataTypeGenerator typeGenerator, SelectionHelper selector,
	...
	/**
	 * Adds any {@link ExtractedField} of an {@link ExtractedType} to a specific
	 * {@link EClass}.
	 * 
	...
	/**
	 * Adds any {@link ExtractedMethod} of an {@link ExtractedType} to an
	 * {@link EClass}.
	 * 
	 * @param type   is the {@link ExtractedType}.
	 * @param eClass is the {@link EClass}.
	...
	/**
	 * Adds a root container {@link EReference} to an root container {@link EClass}.
	 * The root container {@link EReference} is a one-to-many reference to
	 * {@link EObject}.
	 * 
	...
	/**
	 * Adds the declared exceptions of an {@link ExtractedMethod} to an
	 * {@link EOperation}.
	 */
	...
	/**
	 * Adds a field to a {@link EClass} by creating a {@link EStructuralFeature} as
	 * Ecore representation, which is either a {@link EReference} or an
	 * {@link EAttribute}. List types are represented by an
	 * {@link EStructuralFeature} with an undefined upper bound property, which
	 * represents an one-to-many reference. If it is a reference, containment has to
	 * be set manually.
	 */
	...
	/**
	 * Adds a single {@link ExtractedMethod} to a {@link EClass} by creating a
	 * {@link EOperation} as Ecore representation.
	 */
	...
	/**
	 * Adds the parameters of an {@link ExtractedMethod} to a specific List of
	 * {@link EParameter}s.
	 */
	...
	/**
	 * Factory method for the Ecore representations of any
	...
	/**
	 * This method returns the list data type of any {@link ExtractedDataType} which
	 * is of type {@link List} when one-to-many multiplicities are allowed or the
	 * {@link ExtractedDataType} itself for any other case. This ensures that always
	 * the right data type is used for the Ecore representation of an
	 * {@link ExtractedDataType}. For example, a data type List<String> will return
	 * the data type String, but Map<String, String> will return Map<String,
	 * String>.
	 */
	...
	/**
	 * Checks whether a specific {@link ExtractedDataType} is an already created
	 * EClass.
	 */
	...
	/**
	 * Checks whether a {@link ExtractedDataType} can be represented in the Ecore
	 * metamodel by using multiplicities. This depends on three conditions: The data
	 * type is a list type (@see {@link ExtractedDataType#isListType()}), the list
	 * is not a list of wild card types, and the user allowed the use of
	 * multiplicities in the settings.
	 */
	private boolean isMultiplicityRepresentable(ExtractedDataType dataType) {
		return dataType.isListType() && !dataType.getGenericArguments().get(0).isWildcard()
				&& selector.allowsMultiplicities(dataType);
	}

	/**
	 * Sets the upper bound of a {@link ETypedElement} depending on whether the
	 * {@link ExtractedDataType} represents is a list type and whether one-to-many
