...
public class EPackageGenerator {
	 ...
	 * 
	 * @param properties is the {@link ExtractionProperties} class for the
	 *                   extraction.
	 */
	...
	/**
	 * Generates an {@link EPackage} from an {@link ExtractedPackage}. Recursively
	 * calls this method to all contained elements.
	 */
	...
	/**
	 * Builds the URI of an root {@link EPackage} from an {@link ExtractedPackage}.
	 * The URI contains the project name and the default package name (optionally).
	 */
	...
	/**
	 * Builds the URI of an {@link EPackage} from an {@link ExtractedPackage}. The
	 * URI contains the project name, the default package name (optionally), and the
	 * full package name.
	 */
