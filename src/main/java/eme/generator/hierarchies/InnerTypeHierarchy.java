...
public class InnerTypeHierarchy extends EPackageHierarchy {
	 ...
	 * Basic constructor.
	 * 
	 * @param basePackage is the base {@link EPackage} of hierarchy. This is the
	 *                    package of the (most) outer type.
	...
	/**
	 * Adds an {@link EClassifier} to the package hierarchy. Generates the missing
	 * packages for the hierarchy.
	 * 
	 * @param classifier   is the new {@link EClassifier}.
	 * @param relativePath is the relative path of the classifier to the base
	 *                     package. This is used to build the package hierarchy.
	 */
