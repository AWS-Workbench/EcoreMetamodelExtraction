...
public class ExtractedField extends ExtractedVariable {
	...
	/**
	 * Basic constructor, creates the attribute. Sets access level modifier to
	 * {@link AccessLevelModifier}.NO_MODIFIER, final and static to false.
	 * 
	 * @param identifier     is the name of the attribute.
	 * @param fullTypeName   is the full name of type of the attribute, like
	 *                       "java.lang.String", "java.util.list" and "char".
	...
	/**
	 * accessor for the literalValue.
	 * 
	 * @return the literalValue of the method.
	 */
	...
	/**
	 * Mutator for the property literalValue.
	 * 
	 * @param determines the literalValue .
	 */
